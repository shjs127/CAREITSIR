...
<%@ include file="../include/header.jspf"%>
				...
				<div class="row">
					...
					<!-- Welcome Box Starts -->
						<div class="welcome-box text-center">
							<h1 class="text-weight-light">Welcome <br>To FoodBingo!</h1>
	...
	<!-- Menu Card Section Starts -->
		...
		<!-- Menu Card Carousel Starts -->
			...
			<!-- Menu Card #1 Starts -->
				<div class="item slide1 text-xs-center text-sm-center text-md-left">
					<div class="container">
					<!-- Heading Starts -->
					...
					<!-- Menu Card List Starts -->
						<div class="row">
							<div class="col-lg-2 col-md-3 col-sm-12 offset-lg-4">
								<ul class="list-unstyled text-weight-bold">
			...
			<!-- Menu Card #1 Ends -->
			<!-- Menu Card #2 Starts -->
				<div class="item slide2 text-xs-center text-sm-center text-md-left">
					<div class="container">
					<!-- Heading Starts -->
	...
	<!-- Special Offers Section Starts -->
		...
		<!-- Nested Container Starts -->
			<div class="container">
				<h1 class="text-weight-light mt-0 text-xs-center text-sm-center text-md-left">Special Offers</h1>
			<!-- Special Offers Carousel Starts -->
				...
				<!-- Offer Col #1 Starts -->
					<div class="offer-col text-center">
						...
						<div class="content">
							<h4>Food Basera</h4>
							<h6 class="text-weight-light">Take upto 15% Off on entire food order</h6>
							<p class="coupon-code text-uppercase text-weight-bold">Code : 15foodoff</p>
						</div>
					</div>
				<!-- Offer Col #1 Ends -->
				<!-- Offer Col #2 Starts -->
					<div class="offer-col text-center">
						...
						<div class="content">
							<h4>Food Paradise</h4>
							<h6 class="text-weight-light">Take $20 Off when you order from our Mobile App.</h6>
							<p class="coupon-code text-uppercase text-weight-bold">Code : 20moboff</p>
						</div>
					</div>
				<!-- Offer Col #2 Ends -->
				<!-- Offer Col #3 Starts -->
					<div class="offer-col text-center">
						...
						<div class="content">
							...
							<h6 class="text-weight-light">Enjoy up to 20% discount on  order from foodbingo.</h6>
							<p class="coupon-code text-uppercase text-weight-bold">Code : 20foodoff</p>
						</div>
					</div>
				<!-- Offer Col #3 Ends -->
				<!-- Offer Col #4 Starts -->
	...
	<!-- News & Events Section Starts -->
		...
		<!-- Nested Container Starts -->
			<div class="container">
				<h1 class="text-weight-light">News &amp; Events</h1>
			<!-- Nested Row Starts -->
				<div class="row">
				<!-- News #1 Teaser Starts -->
					<div class="col-lg-4 col-md-6 col-sm-12">
						<article class="news-block">
						<!-- News Heading Starts -->
							<div class="clearfix">
								<div class="news-meta">
									<h2 class="date text-weight-bold">15</h2>
									<h5 class="month text-uppercase">Jan</h5>
								</div>
								<h6 class="text-weight-normal"><a href="#">Lorem Ipsum is simply dummy text of the printing..</a></h6>	
							</div>
						<!-- News Heading Ends -->
							<p>
								It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using..
							</p>
							<a href="#" class="btn btn-prime text-uppercase text-weight-ultra-bold animation">More</a>
						</article>
					</div>
				<!-- News #1 Teaser Ends -->
				<!-- News #2 Teaser Starts -->
					<div class="col-lg-4 col-md-6 col-sm-12">
						<article class="news-block">
						<!-- News Heading Starts -->
							<div class="clearfix">
								<div class="news-meta">
									<h2 class="date text-weight-bold">20</h2>
									<h5 class="month text-uppercase">Feb</h5>
								</div>
								<h6 class="text-weight-normal"><a href="#">Lorem Ipsum is simply dummy text of the printing..</a></h6>	
							</div>
						<!-- News Heading Ends -->
							...
							<a href="#" class="btn btn-prime text-uppercase text-ultra-bold animation">More</a>
						</article>
					</div>
				<!-- News #2 Teaser Ends -->
				<!-- News #3 Teaser Starts -->
					<div class="col-lg-4 col-md-6 col-sm-12">
						<article class="news-block">
						<!-- News Heading Starts -->
							<div class="clearfix">
								<div class="news-meta">
									<h2 class="date text-weight-bold">07</h2>
									<h5 class="month text-uppercase">Mar</h5>
								</div>
								<h6 class="text-weight-normal"><a href="#">Lorem Ipsum is simply dummy text of the printing..</a></h6>	
							</div>
						<!-- News Heading Ends -->
			...
			<!-- Nested Row Starts -->
				<div class="row">
					<div class="col-md-8 col-sm-12 order-md-last">
						<div class="content">
							<h3>The Best FoodBingo Delivery App!</h3>
