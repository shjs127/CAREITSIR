...
<%@ include file="header.jspf"%>
	...
	<!-- Main Container Starts -->
                ...
                <!-- Login Col Starts -->
                    ...
                    <!-- Login Form Starts -->
                        <form>
                            ...
                            <button href="join.do" class="btn btn-block btn-prime animation">
                                회원가입 <i class="fa fa-caret-right"></i>
                            </button>
                            <div class="form-group">
        ...
        <!-- Banners Starts -->
            <div class="row">
                <div class="col-3">
                    <a href="#"><img src="images/banners/banner-img1.png" alt="Banner 1" class="img-fluid"></a>
                </div>
                <div class="col-3">
                    <a href="#"><img src="images/banners/banner-img2.png" alt="Banner 2" class="img-fluid"></a>
                </div>
                <div class="col-3">
                    <a href="#"><img src="images/banners/banner-img3.png" alt="Banner 3" class="img-fluid"></a>
                </div>
                <div class="col-3">
                    <a href="#"><img src="images/banners/banner-img1.png" alt="Banner 1" class="img-fluid"></a>
                </div>
